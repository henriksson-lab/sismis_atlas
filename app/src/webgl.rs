...
impl Component for App {
    ...
    fn rendered(&mut self, _ctx: &Context<Self>, first_render: bool) {
        ...
        let gl: GL = canvas
            ...
            .dyn_into()
            .unwrap();
        //Self::render_gl_rect(&gl);

        Self::render_gl_umap(&gl);
...
impl App {
    ...
    pub fn render_gl_rect(gl: WebGlRenderingContext) {
    ...
    fn render_gl_umap(gl: &WebGlRenderingContext) {
        // This should log only once -- not once per frame
        ...
        gl.draw_arrays(GL::POINTS, 0, num_points);
